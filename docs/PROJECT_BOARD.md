...
This document describes the structure and usage of the hexaMobileShare GitHub Project Board used for tracking issues, workflows, and development progress.

---

## 🧭 Board Overview

The hexaMobileShare project board is organized using GitHub Projects (v2) with the following columns:
