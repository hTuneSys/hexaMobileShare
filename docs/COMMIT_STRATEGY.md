...
## 🔖 Commit Message Strategy for hexaMobileShare

To ensure consistent and readable commit messages across the project, **hexaMobileShare** enforces the use of a standardized commit format and a predefined set of commit types.
