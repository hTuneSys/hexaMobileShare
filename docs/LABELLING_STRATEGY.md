...
This document defines the complete, system-approved label taxonomy used in the hexaMobileShare GitHub repository. These labels help organize issues and pull requests for better triage, automation, and collaboration.
...
- `module:packages` – Packages and libraries
- `module:widgetbook` - Widgetbook integration
...
This standardized labeling system enables GitHub automation, PR triage, and progress tracking across the hexaMobileShare project.
